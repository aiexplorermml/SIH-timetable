  ...
  <TooltipProvider>
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/department/aiml/faculty" element={<DepartmentFaculty />} />
        <Route path="/department/aiml/faculty/:id" element={<FacultyDetail />} />
        <Route path="/department/aiml/faculty/:id/edit" element={<FacultyEdit />} />
        <Route path="/department/aiml/classes" element={<DepartmentClasses />} />
        <Route path="/department/aiml/classes/progress" element={<DepartmentClasses />} />
        <Route path="/department/aiml/timetable" element={<DepartmentTimetable />} />
        <Route path="/department/aiml/curriculum" element={<Curriculum />} />
        <Route path="/department/aiml/curriculum/subjects" element={<CurriculumSubjects />} />
        <Route path="/department/aiml/curriculum/mapping" element={<SubjectMapping />} />
        ...
        <Route path="/department/:department/faculty" element={<DepartmentFaculty />} />
        <Route path="/department/:department/faculty/:id" element={<PrototypePage />} />
        <Route path="/department/:department/faculty/:id/edit" element={<PrototypePage />} />
        <Route path="/department/:department/classes" element={<DepartmentClasses />} />
        <Route path="/department/:department/classes/progress" element={<DepartmentClasses />} />
        <Route path="/department/:department/timetable" element={<DepartmentTimetable />} />
        <Route path="/department/:department/curriculum" element={<PrototypePage />} />
        <Route path="/department/:department/news" element={<PrototypePage />} />
        ...
        <Route path="/admin/faculty-management/:id/edit" element={<FacultyEditDetail />} />
